...
export const constantRouterMap = [
    {path: '/regin',name: 'regin',hidden: true,component: Regin},
...

 {
    ...
    children: [
     ...
     {path: '/components',name: 'component组件',redirect: '/components/buttons',icon:'bookmark',
      ...
      {path: '/rjk',name: 'rjk',icon:"social-html5",component: _import('rjk')},
      {path: '/Vuex',name:'vuex',icon:"android-apps",component: _import('Vuex')},      
    ]
  },
